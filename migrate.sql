...
INSERT INTO etablissements (id, etablissement) VALUES
  ...
  (49, 'Ambassade d''Algérie en France'),
  (50, 'CEA'),
  (51, 'I2S'),
  (52, 'Chennai Mathematical Institute'),
  (53, 'EA4T'),
  (54, 'Bordeaux Sciences Agro'),
  (55, 'Grenoble INP'),
  (56, 'IBM France'),
  (57, 'Education Nationale'),
  (58, 'INSA Toulouse'),
  (59, 'THALES'),
  (60, 'Atos Integration'),
  ...
  (66, 'SIRIC BRIO2'),
  (67, 'STARTUP KUNE'),
  (68, 'BEIHANG UNIVERSITY'),
  (69, 'Bourse'),
  (70, 'Goodyear S.A'),
  (71, 'UNIVERSITÉ LAVAL'),
  (72, 'Ubisoft Bordeaux'),
  (73, 'Universidad Nacional de La Plata'),
  (74, 'International Institute of Information Technology Hyderabad'),
  (75, 'Université de Perpignan'),
  (76, 'SERMA Safety & Security'),
  (77, 'General Electric'),
  (78, 'BNP Paribas Personal Finance'),
  (79, 'Université catholique Péter Pázmány'),
  (80, 'Télécom ParisTech'),
  (81, 'École Nationale Supérieure d’Informatique pour l’Industrie et l’Entreprise'),
  (82, 'EFREI Paris'),
  (83, 'IDEMIA'),
  (84, 'University of Medicine'),
  (85, 'Université de Trente '),
  (86, 'ESTIA Bidart'),
  (87, 'Naval Group'),
  (88, 'LECTRA SA'),
  (89, 'Institut national des télécommunications et des technologies de l''information et de la communication'),
  (90, 'National Taipei University of Business Taipei'),
  (91, 'NATIONAL CHENG KUNG UNIVERSITY'),
  (92, 'ENS Cachan'),
  (93, 'École nationale supérieure d''informatique Alger'),
  (94, 'University de Grenoble Alpes'),
  (95, 'Université Pierre-et-Marie-Curie'),
  (96, 'Sorbonne Universités'),
  (97, 'Université de Sousse'),
  (98, 'JOADA'),
  (99, 'UTC - Compiègne'),
  (100, 'CETIM Sud Ouest'),
  (101, 'Promyze'),
  (102, 'La Sapienza University'),
  (103, 'INRAE'),
  (104, 'Ecole d''ingénieurs du Mans'),
  (105, 'CIS Valley'),
  (106, 'Université de La Réunion'),
  (107, 'ENS de l''éclectronique et de ses applications- Cergy-Pontoise'),
  (108, 'Université de Valladolid'),
  (109, 'Université Reims-Champagne-Ardenne'),
  (110, 'CONACYT - Consejo Nacional de Ciencia y Tecnología'),
  (111, 'Instituto Politécnico Nacional Tijuana'),
  (112, 'Auréa agrosciences'),
  (113, 'Université d''Augsbourg'),
  (114, 'Université de Vérone'),
  (115, 'University of Münster'),
  (116, 'ITECA'),
  (117, 'Université de Padoue'),
  (118, 'ENS ESI Alger'),
  (119, 'University of Antwerp'),
  (120, 'Lucine'),
  (121, 'BERGER LEVRAULT'),
  (122, 'Ecole Nationale supérieure de cognitique - Institut polytechnique de Bordeaux'),
  (123, 'Université autonome de Barcelone'),
  (124, 'Bull SAS'),
  (125, 'IFPEN '),
  (126, 'Skolkovo Institute of Science and Technology'),
  (127, 'Université technique de Rhénanie-Westphalie'),
  (128, 'Univesité des sciences, des techniques et des technologies de Bamako'),
  (129, 'Johns Hopkins University'),
  (130, 'CERFACS'),
  (131, 'University of Electronic Science and Technology of China'),
  (132, 'InfleXys'),
  (133, 'University of Illinois'),
  (134, 'Ferrocampus'),
  (135, 'Université d''Oran'),
  (136, 'Université Amiens Picardie Jules Verne'),
  (137, 'Universidade Federal de Santa Catarina Florianópolis'),
  (138, 'CNAM'),
  (139, 'DataDirectNetworks France'),
  (140, 'Université de Rouen Normandie'),
  (141, 'Université Paris XI'),
  (142, 'Indian Institute of Technology Kharagpur'),
  (143, 'Institut International de Technologie de Sfax'),
  (144, 'Scille'),
  (145, 'École polytechnique fédérale de Zurich'),
  (146, 'École Nationale Supérieure de Sciences Appliquées et de Technologies Lannion'),
  (147, 'Alltech Nouvelle Aquitaine'),
  (148, 'Vegetal signals'),
  (149, 'Institut supérieur des sciences appliquées et de technologie de Sousse'),
  (150, 'Université de la Manouba'),
  (151, 'Orosys'),
  (152, 'Mangrove'),
  (153, 'Université Libre de Bruxelles'),
  (154, 'Pas de gratification'),
  (155, 'La Rochelle Université'),
  (156, 'Ecole Nationale d''Ingénieurs de Tunis'),
  (157, 'ENSC'),
  (158, 'Ecole Nationale d''Ingénieurs de Brest')
ON CONFLICT (id) DO NOTHING;
